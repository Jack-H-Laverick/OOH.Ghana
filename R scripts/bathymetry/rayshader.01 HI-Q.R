...
S <- nrow(nc_lat)*(90+10)/180 ; N <- nrow(nc_lat)*(90+23)/180
W <- length(nc_lon)*(180-19)/360 ; E <- length(nc_lon)*(180-13)/360     # For Mercatore
...
render_highquality(print_scene_info = T, parallel = TRUE, lightintensity = 0, samples = 3500, filename = "rayshade-hi.png", 
                   scene_elements = bind_rows(rayrender::sphere(z = 100, y = 2000, x = 600, radius = 50,
                                                                material = rayrender::light(color = "white", intensity = 1000)),
                                              rayrender::sphere(z = -7500, y = 2000, x = 2000, radius = 50,
                                                                material = rayrender::light(color = "white", intensity = 1000)),
                                              rayrender::sphere(z = -15000, y = 2000, x = 2000, radius = 50,
                                                                material = rayrender::light(color = "white", intensity = 1000)),
                                              rayrender::sphere(z = 7500, y = 2000, x = 600, radius = 50,
                                                                material = rayrender::light(color = "white", intensity = 1000)),
                                              rayrender::text3d(label = "Mauritania to Senegal", angle = c(-30, 60, 0), z = 15000, y = 1000, x = -650, 
